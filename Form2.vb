...
Public Class Form2
        ...
        Using sqlConn As New MySqlConnection(connString)
            Using sqlComm As New MySqlCommand(sqlQuery, sqlConn)
                ...
                Try
                    ...
                    Else
                        MessageBox.Show("Error: An error has occurred, please provide valid product code.")
                    End If
                    sqlReader.Close()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles save.Click
        ...
        Try
            ...
            Else
                MessageBox.Show("Error: An error has occurred, please provide valid data for all fields.")
            End If
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles clear.Click
        ...
        MessageBox.Show("All fields have been cleared successfully.")
        '==================================================================
    End Sub
End Class